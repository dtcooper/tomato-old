    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('begin', models.DateTimeField(blank=True, help_text='Optional date when eligibility for random selection *begins*. If specified, random selection is enabled after this date.', null=True, verbose_name='Begin Air Date')),
                ('end', models.DateTimeField(blank=True, help_text='Optional date when eligibility for random selection *ends*. If specified, random selection is enabled before this date.', null=True, verbose_name='End Air Date')),
                ...
                ('name', models.CharField(blank=True, db_index=True, help_text="If left unspecified, we'll base it off the filename. If uploading multiple files, leave this empty.", max_length=75, verbose_name='Optional Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rotator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.Rotator', verbose_name='Rotator')),
                ('stopset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.StopSet')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='rotator',
            name='stopsets',
            field=models.ManyToManyField(related_name='rotators', through='data.StopSetRotator', to='data.StopSet'),
        ),
        migrations.AddField(
            model_name='asset',
            name='rotators',
            field=models.ManyToManyField(related_name='assets', through='data.RotatorAsset', to='data.Rotator'),
        ),
    ]
