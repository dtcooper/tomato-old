# Generated by Django 3.0.1 on 2019-12-23 03:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tomato.Asset')),
                ('rotator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tomato.Rotator', verbose_name='Rotator')),
            ],
            options={
                'verbose_name': 'Rotator',
        ...
        migrations.AddField(
            model_name='rotator',
            name='stopsets',
            field=models.ManyToManyField(related_name='rotators', through='tomato.StopSetRotator', to='tomato.StopSet'),
        ),
        migrations.AddField(
            model_name='asset',
            name='rotators',
            field=models.ManyToManyField(related_name='assets', through='tomato.RotatorAsset', to='tomato.Rotator'),
        ),
        migrations.CreateModel(
            name='ApiToken',
            fields=[
